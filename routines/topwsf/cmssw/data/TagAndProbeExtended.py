"""ParticleNet top/W tag-and-probe Combine physics model.

This file is copied from references/ParticleNetSF/TagAndProbeExtended.py and
installed into HiggsAnalysis/CombinedLimit/python by routines/topwsf/cmssw/env_setup.sh.
"""
